...
namespace NUnit_PricingCalculator_TestProject
{
    ...
    {        
        ...
        public void PriceCalculateService_CalculatePriceForService_Customer_Referense_null_Test()
        {
            ...
            // Act
            // actual
            Assert.Throws<ArgumentNullException>(() => this.m_PriceCalculateService.CalculatePriceForService(customer, CallingService.SERVICE_A, dtStartDate, dtEndDate));
        ...
        public void PriceCalculateService_CalculatePriceForService_StartDate_After_EndDate_Test()
        {
            ...
            // Act
            // actual
            Assert.Throws<ArgumentException>(() => this.m_PriceCalculateService.CalculatePriceForService(customer, CallingService.SERVICE_A, dtStartDate, dtEndDate));
        ...
        public void PriceCalculateService_CalculatePriceForService_Customer_HasItsOwnCostForService_Test()
        {
            ...
            // Act
            // actual
            double dblActualCost = this.m_PriceCalculateService.CalculatePriceForService(customer, CallingService.SERVICE_A, dtStartDate, dtEndDate);
        ...
        public void PriceCalculateService_CalculatePriceForService_Customer_Use_base_cost_from_config_HasDiscount_In_Period_Test()
        {
            ...
            Assert.AreEqual(1 * dblExpectedCost1 + 3 * dblExpectedCost, dblActualCost);
        }
